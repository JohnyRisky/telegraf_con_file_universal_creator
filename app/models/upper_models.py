...
from .stores import *
from .common_params import TIME_INTERVAL_REGEX
...
class AgentParams(BaseModel):
    ...
    logformat: Literal["text", "structured", "eventlog"] | None = None
    ...
    snmp_translator: Literal["netsnmp", "gosmi"] | None = None
    ...
    buffer_strategy: Literal["disk", "memory"] | None = None
...
class InputsPlugins(BaseModel):
    ...
    iptables: list[Iptables] | None = None
    ...
    openldap: list[OpenLDAP] | None = None
    ...
    vsphere: list[Vsphere] | None = None
